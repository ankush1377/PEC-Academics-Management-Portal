	...
	if ($marksListResult->num_rows > 0) {
		while($marksListRow = $marksListResult->fetch_array(MYSQLI_ASSOC)) {
            ...
            //    print (int)$subjectMarksRow["quiz4"];
                ...
                if( (int)$subjectMarksRow["assignment2"] != '0')
                ...
                if( (int)$subjectMarksRow["assignment3"] != '0')
                ...
                if( (int)$subjectMarksRow["assignment4"] != '0')
                ...
                if( (int)$subjectMarksRow["assignment5"] != '0')
